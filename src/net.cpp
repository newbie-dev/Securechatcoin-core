...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Securechatcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"cointool.net", "seed.cointool.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"securechatcointools.com", "testnet-seed.securechatcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Securechatcoin is probably already running."), addrBind.ToString().c_str());
        else
